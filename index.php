    ...
    <section id="services" class="services section-bg">
      <div class="container">
        <div class="section-title" data-aos="fade-up">
          <h2>Services</h2>
          <p>
            In our Institute we have several Technology.
          </p>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in">
            <div class="icon-box icon-box-pink">
              ...
              <h4 class="title"><a href="">Computer Technology</a></h4>
              <p class="description">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box icon-box-cyan">
              ...
              <h4 class="title"><a href="">Civil Technology</a></h4>
              <p class="description">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box icon-box-green">
              ...
              <h4 class="title"><a href="">Electrical Technology</a></h4>
              <p class="description">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box icon-box-blue">
              ...
              <h4 class="title"><a href="">Textile Technology</a></h4>
              <p class="description">
  ...
  <footer id="footer">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              <p>
                BAN - Tejgaon, <br />
                Dhaka 20,West Testuri Bazar Road<br /><br />
                <strong>Phone:</strong>+ 9130508, 9130613,9120248<br />
                <strong>Email:</strong> itvetofaust@yahoo.com<br />
              </p>
    ...
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://github.com/Mohiuddin-64bit">Md Mohiuddin</a>
      </div>
    </div>
  </footer>
  <!-- End Footer -->
